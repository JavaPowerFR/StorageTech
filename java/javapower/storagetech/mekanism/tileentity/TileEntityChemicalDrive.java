...
public class TileEntityChemicalDrive extends NetworkNodeTile<NetworkNodeChemicalDrive>
{
	@ObjectHolder(StorageTech.MODID+":chemicaldrive")
	public static final TileEntityType<TileEntityChemicalDrive> CURRENT_TILE = null;
	
	public static final TileDataParameter<Long, TileEntityChemicalDrive> STORED = new TileDataParameter<>(RSSerializers.LONG_SERIALIZER, 0L, t -> (long)t.getNode().getAmount());
	public static final TileDataParameter<Long, TileEntityChemicalDrive> CAPACITY = new TileDataParameter<>(RSSerializers.LONG_SERIALIZER, 0L, t -> t.getNode().getCapacity());
    ...
    public TileEntityChemicalDrive()
    {
        super(CURRENT_TILE);
    ...
    @Override
    @Nonnull
    public NetworkNodeChemicalDrive createNode(World world, BlockPos pos)
    {
        return new NetworkNodeChemicalDrive(world, pos);
    }
