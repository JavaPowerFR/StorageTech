...
public class BlockGasDrive extends NetworkNodeBlock
{
	protected Item thisItem;
	public static String raw_name = "gasdrive";
	
	public BlockGasDrive()
	{
    ...
    public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit)
    {
        if (!world.isRemote)
        {
           return NetworkUtils.attemptModify(world, pos, hit.getFace(), player, () -> NetworkHooks.openGui((ServerPlayerEntity) player, new PositionalTileContainerProvider<TileEntityGasDrive>(
        		   new TranslationTextComponent("gui.storagetech.gas_drive"),
                (tile, windowId, inventory, p) -> new ContainerGasDrive(tile, player, windowId),
                pos
            ), pos));
        }
