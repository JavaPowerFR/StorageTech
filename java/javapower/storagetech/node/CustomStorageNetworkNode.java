...
public class CustomStorageNetworkNode extends NetworkNode implements IStorageScreen, IStorageProvider, IComparable, IWhitelistBlacklist, IPrioritizable, IAccessType, IStorageDiskContainerContext {

    private static final Logger LOGGER = LogManager.getLogger(CustomStorageNetworkNode.class);
    ...
    public CustomStorageNetworkNode(World world, BlockPos pos, CustomStorageTile _ten)
    {
        super(world, pos);
        ten = _ten;
    }
    ...
    public void loadStorage()
    {
        ...
        if (disk == null)
        {
        	...
        	if(node instanceof CustomStorageNetworkNode)
        	{
	            API.instance().getStorageDiskManager((ServerWorld) world).set(storageId, disk = API.instance().createDefaultItemDisk((ServerWorld) world, ((CustomStorageNetworkNode)node).getStorageCapacity()));
