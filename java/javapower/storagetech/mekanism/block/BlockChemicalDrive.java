...
public class BlockChemicalDrive extends NetworkNodeBlock
{
	protected Item thisItem;
	public static String raw_name = "chemicaldrive";
	
	public BlockChemicalDrive()
	{
    ...
    {
        return new TileEntityChemicalDrive();
    }
