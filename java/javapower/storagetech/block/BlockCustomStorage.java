...
public class BlockCustomStorage extends NetworkNodeBlock
{
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, @Nullable LivingEntity entity, ItemStack stack)
	{
        if (!world.isRemote)
        {
            NetworkNodeCustomStorage storage = ((CustomStorageTile) world.getTileEntity(pos)).getNode();

            if (stack.hasTag() && stack.getTag().hasUniqueId(NetworkNodeCustomStorage.NBT_ID))
            {
