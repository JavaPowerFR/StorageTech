...
public class ItemCustomFluidStoragePart extends Item implements ICustomStoragePart
{
	public ItemCustomFluidStoragePart()
	{
		super(STItems.DEFAULT_PROPERTIES);
		setRegistryName(StorageTech.MODID,"custom_fluid_storage_part");
	}
	...
	public ITextComponent getDisplayName(ItemStack stack)
	{
		...
		if(nbt != null && nbt.contains("partvalue"))
		{
			return new TranslationTextComponent(
					"item.storagetech.custom_fluid_storage_part.advanced",
	...
	{
		ItemStack item = new ItemStack(STItems.item_custom_fluid_storage_part, 1);
	...
	{
		ItemStack stackDisk = new ItemStack(STItems.item_fluiddiskcustom,1);
		CompoundNBT nbt = new CompoundNBT();
