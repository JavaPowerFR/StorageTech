...
public class ContainerGasExporter extends BaseContainer
{
	@ObjectHolder(StorageTech.MODID+":gasexporter")
    public static final ContainerType<ContainerGasExporter> CURRENT_CONTAINER = null;
    ...
    public ContainerGasExporter(TileEntityGasExporter exporter, PlayerEntity player, int windowId)
    {
        ...
        for (int i = 0; i < 9; ++i)
        {
            addSlot(new GasFilterSlot(exporter.getNode().getGasFilters(), i, 8 + (18 * i), 20));
        }
