...
public class FluidDiskWorkbenchMemory
{
	public static class Category implements IRecipeCategory<Wrapper>
	{
		...
		public static final String UID = StorageTech.MODID + ".diskfwbm";
		...
		{
			localizedName = I18n.format(StorageTech.MODID+".jei.category.diskfwbm");
			background = guiHelper.createDrawable(ResourceLocationRegister.textrue_gui_jei_recipe, 27, 67, 20, 69);
		}
