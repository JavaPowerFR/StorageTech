...
public class ScreenGasExporter extends BaseScreen<ContainerGasExporter>
{
    private final String texture;

    public ScreenGasExporter(ContainerGasExporter container, PlayerInventory inventory, ITextComponent title)
    {
    ...
    {
    	addSideButton(new RedstoneModeSideButton(this, TileEntityGasExporter.REDSTONE_MODE));
    }
