...
public class GuiContainerFluidDiskWorkbench extends GuiContainer implements IGUITileSync
{
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
        ...
        else
        {
	        ...
	        this.drawString(fontRenderer, Tools.longFormatToString(memory)+" VFT", x + 28, y + 17, 0xffffff);
	        this.drawString(fontRenderer, i18nBuffer[2]+" VFT:", x + 28, y + 47, 0xffffff);
        }
        
        textField_size.drawTextBox();
        
        this.drawString(fontRenderer, "VFT: Virtual Fluid Tank", x + 34, y + 87, 0xffffff);
        this.drawString(fontRenderer, "1 VFT = "+i18nBuffer[6]+" 1 mb", x + 40, y + 97, 0xffffff);
