...
public class BlockChemicalImporter extends CableBlock
{
	protected Item thisItem;
	public static String raw_name = "chemicalimporter";
    ...
    {
        return new TileEntityChemicalImporter();
    }
