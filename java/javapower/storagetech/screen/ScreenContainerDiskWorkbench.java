...
public class ScreenContainerDiskWorkbench extends ContainerScreen<ContainerDiskWorkbench>
{
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
        ...
        else
        {
	        ...
	        this.drawString(font, i18nBuffer[2]+" VIB:", guiLeft + 28, guiTop + 47, 0xffffff);
        
        }
	    
	    //textField_size.render(mouseX, mouseY, partialTicks);//TODO
	    
	    this.drawString(font, "VIB: Virtual Item Box", guiLeft + 34, guiTop + 87, 0xffffff);
        this.drawString(font, "1 VIB = "+i18nBuffer[6]+" 1 item", guiLeft + 40, guiTop + 97, 0xffffff);
