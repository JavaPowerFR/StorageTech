...
public class ScreenChemicalDrive extends BaseScreen<ContainerChemicalDrive>
{
    ...
    public ScreenChemicalDrive(ContainerChemicalDrive container, PlayerInventory inventory, ITextComponent title)
    {
        super(container, 176, 207, inventory, title);

        texture = "guis/chemical_drive.png";
        redstonemode = TileEntityChemicalDrive.REDSTONE_MODE;
        storedSupplier = TileEntityChemicalDrive.STORED::getValue;
        capacitySupplier = TileEntityChemicalDrive.CAPACITY::getValue;
    }
