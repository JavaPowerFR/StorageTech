...
public class ItemFluidDiskCustom extends Item implements IStorageDiskProvider
{

	public ItemFluidDiskCustom()
	{
		super(STItems.DEFAULT_PROPERTIES);
		setRegistryName(StorageTech.MODID,"fluidcustomdisk");
	}
	...
	public void inventoryTick(ItemStack stack, World world, Entity entityIn, int itemSlot, boolean isSelected)
	{
        ...
        if(!world.isRemote && stack.hasTag() && stack.getTag().contains("s"))
		{
            ...
            API.instance().getStorageDiskManager((ServerWorld) world).set(id, API.instance().createDefaultFluidDisk((ServerWorld) world, getCapacity(stack), (PlayerEntity) entityIn));
	...
	public ITextComponent getDisplayName(ItemStack stack)
	{
		if(stack.hasTag() && stack.getTag().contains("st_cap"))
			return new TranslationTextComponent("item.storagetech.fluidcustomdisk.val", Tools.longFormatToString(stack.getTag().getInt("st_cap")));
